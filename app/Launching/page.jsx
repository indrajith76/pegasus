const Launching =()=>{
    ...
    <div className=" bg-[#291b2282] flex flex-col-reverse  lg:flex-row border border-[5px] border-black rounded-[7px]">
      <div className="pb-5 lg:w-[550px] lg:h-[744px] relative">
        <div className=" mx-[25px] pt-5 lg:pt-0 lg:absolute bottom-5">
            ...
            <p className="bg-[#00000040] border border-black py-[2px] px-6 rounded lg:text-[19px] text-center dm-mono mt-6">pegv1 - [UPDATE PANEL]</p>
          </div>
        </div>
        <div className="bg-[#0000004d] w-full border-0 lg:border-l-[5px] border-black px-[29px] py-[26px]">
          ...
          <div className="my-[96px] lg:mt-[196px] w-[80%] mx-auto h-[5px] bg-[#00000080] rounded overflow-hidden">
